...
if ($_POST) {
  ...
  while (true) {
    ...
    $connection->Query("INSERT INTO `".$_POST['db_prefix']."pages` (`title`, `alt`, `html`, `in_menu`, `active`, `tpl`) VALUES ('".$L['text_main']."', 'index', '".fsFunctions::StringFormat($L['text'], array('http://'.$_SERVER["SERVER_NAME"].'/'.(i('multilang', 'true', false) == 'true' ? $lang.'/' : '').'AdminPanel/Hello'.$url_suffix))."', '1', '1', 'Index.php');");
