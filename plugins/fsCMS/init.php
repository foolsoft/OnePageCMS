...
if (AUTH_ADMIN && !IS_ADMIN_CONTROLLER) {
    ...
    $_REQUEST['includeBody'] .= "<div class='admin_panel_top' id='admin-panel-top' style='border-bottom:2px solid #000;margin:0px;position:fixed;top:0px;background:rgba(0,0,0,0.5);width:100%;height:22px;left:0px;z-index:99999999999;'><a style='float:left;text-decoration:none;color:#EEE;font-family:Tahoma;padding-left:15px;' onmouseout=\"this.style.color='#EEE';\" onmouseover=\"this.style.color='#FFFF00';\" href='".fsHtml::Url(URL_ROOT."AdminPanel/Hello")."' title='".$PA."'>".$PA."</a><a href='javascript:;' onclick=\"$('#admin-panel-top').slideUp('slow');\" style='float:right;text-decoration:none;color:#EEE;font-family:Tahoma;margin-right:10px;' onmouseout=\"this.style.color='#EEE';\" onmouseover=\"this.style.color='#FFFF00';\" title='".$HL."'>X</a></div>";  
    unset($HL); unset($PA);
}