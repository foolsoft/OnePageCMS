...
class fsMenuGenerator 
{
    ...
    public static function GetArray($table, $fieldToParent = '', $fieldToKey = 'id', $fieldToLink = 'alt', $fieldToTitle = 'title', $order = array('position'), $where = "`in_menu` = '1' AND `active` = '1'", $additionalFields = array()) 
    {
    ...
    {
      $menuArray = self::GetArray($table, $fieldToParent, $fieldToKey, $fieldToLink, $fieldToTitle, $order, $where);
